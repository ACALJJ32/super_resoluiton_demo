...
from utils.utils import flow_warp, ResidualBlocksWithInputConv, SPyNet, PixelShufflePack
...
class BasicVSRPlusPlus(nn.Module):
    ...
    def forward(self, lqs):
        ...
        # flow visualization
        flow_out = flows_backward[0].clone()
        ...
        return self.upsample(lqs, feats), flow_out
