...
from utils.utils import (PixelShufflePack, ResidualBlockNoBN,
                                  flow_warp, make_layer)

from utils.archs.basicvsr_pp import ResidualBlocksWithInputConv, SPyNet
from utils.archs.edvr import PCDAlignment, TSAFusion
...
class IconVSR(nn.Module):
    ...
    def forward(self, lrs):
        ...
        return torch.stack(outputs, dim=1)[:, :, :, :4 * h_input, :4 * w_input], flow
